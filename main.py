...
# Set environment variables or use st.secrets if running in Streamlit Cloud
...
if 'token' not in st.session_state:
    ...
    scope_str = " ".join(SCOPE)  # Join list into a single string
...
books_api_key = st.secrets["books"]["api_key"]
